...
export default function TreatmentPlanningForm() {
  ...
  const handleMultiSelectChange = (field: keyof FormData, values: string[]) => {
    console.log(`Actualizando ${field}:`, values)
  ...
  const onSubmit = (data: FormData) => {
    ...
    console.log("Valores de manufactura:", data.manufactura)
    console.log("Valores de consideraciones:", data.consideracionesDiagnosticas)
    console.log("Valores de criterio:", data.criterioAccionClinica)
  ...
  return (
    <div className="max-w-4xl mx-auto py-10">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Planificación de Tratamiento</h1>
        <p className="text-gray-600">Complete el formulario para la planificación del caso ortodóntico</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div>
          ...
          <Select onValueChange={(value) => setValue("maxilares", value)}>
            <SelectTrigger>
        ...
        <div>
          ...
          <RadioGroup
            onValueChange={(value: string) => setValue("complejidad", value)}
        ...
        <div>
          ...
          <RadioGroup
            onValueChange={(value: string) => setValue("pronostico", value)}
            className="flex flex-col space-y-1"
          >
            {[
              ["Favorable", "favorable"],
        ...
        <div>
          ...
          <Select onValueChange={(value) => {
            const currentValues = watch("manufactura") || []
            if (currentValues.includes(value)) {
              handleMultiSelectChange("manufactura", currentValues.filter(v => v !== value))
            } else {
              handleMultiSelectChange("manufactura", [...currentValues, value])
            }
          }}>
          ...
          {watch("manufactura") && watch("manufactura").length > 0 && (
            <div className="mt-2 flex flex-wrap gap-1">
              {watch("manufactura").map((value) => (
                <span key={value} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-blue-100 text-blue-800">
                  {value}
                  <button
                    type="button"
        ...
        <div>
          ...
          <Select onValueChange={(value) => {
            const currentValues = watch("consideracionesDiagnosticas") || []
            if (currentValues.includes(value)) {
              handleMultiSelectChange("consideracionesDiagnosticas", currentValues.filter(v => v !== value))
            } else {
              handleMultiSelectChange("consideracionesDiagnosticas", [...currentValues, value])
            }
          }}>
            <SelectTrigger className="w-full max-w-xs">
          ...
          {/* Mostrar valores seleccionados */}
          {watch("consideracionesDiagnosticas") && watch("consideracionesDiagnosticas").length > 0 && (
            <div className="mt-2 flex flex-wrap gap-1">
              {watch("consideracionesDiagnosticas").map((value) => (
                <span key={value} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-green-100 text-green-800">
                  {value}
                  <button
                    type="button"
        ...
        <div>
          ...
          <Select onValueChange={(value) => {
            const currentValues = watch("criterioAccionClinica") || []
            if (currentValues.includes(value)) {
              handleMultiSelectChange("criterioAccionClinica", currentValues.filter(v => v !== value))
            } else {
              handleMultiSelectChange("criterioAccionClinica", [...currentValues, value])
            }
          }}>
            <SelectTrigger className="w-full max-w-xs">
          ...
          {/* Mostrar valores seleccionados */}
          {watch("criterioAccionClinica") && watch("criterioAccionClinica").length > 0 && (
            <div className="mt-2 flex flex-wrap gap-1">
              {watch("criterioAccionClinica").map((value) => (
                <span key={value} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-purple-100 text-purple-800">
                  {value}
                  <button
                    type="button"
        ...
        <div>
          ...
          <Select onValueChange={(value) => {
            const currentValues = watch("derivaciones") || []
            if (currentValues.includes(value)) {
              handleMultiSelectChange("derivaciones", currentValues.filter(v => v !== value))
            } else {
              handleMultiSelectChange("derivaciones", [...currentValues, value])
            }
          }}>
            <SelectTrigger className="w-full max-w-xs">
          ...
          {/* Mostrar valores seleccionados */}
          {watch("derivaciones") && watch("derivaciones").length > 0 && (
            <div className="mt-2 flex flex-wrap gap-1">
              {watch("derivaciones").map((value) => (
                <span key={value} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-orange-100 text-orange-800">
                  {value}
                  <button
                    type="button"
        ...
        <div>
          ...
          <Select onValueChange={(value) => {
            const currentValues = watch("potencialVenta") || []
            if (currentValues.includes(value)) {
              handleMultiSelectChange("potencialVenta", currentValues.filter(v => v !== value))
            } else {
              handleMultiSelectChange("potencialVenta", [...currentValues, value])
            }
          }}>
            <SelectTrigger className="w-full max-w-xs">
          ...
          {/* Mostrar valores seleccionados */}
          {watch("potencialVenta") && watch("potencialVenta").length > 0 && (
            <div className="mt-2 flex flex-wrap gap-1">
              {watch("potencialVenta").map((value) => (
                <span key={value} className="inline-flex items-center px-2 py-1 rounded-md text-xs font-medium bg-pink-100 text-pink-800">
                  {value}
                  <button
                    type="button"

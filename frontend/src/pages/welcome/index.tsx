  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gray-100/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-8 w-full">
        ...
        <div className="mb-16">
          ...
          >
            Tu plataforma integral para planificación de tratamientos dentales en 3D. 
            Comienza a crear experiencias digitales extraordinarias.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm text-gray-400" style={{ fontFamily: 'SF Pro Text, -apple-system, BlinkMacSystemFont, sans-serif' }}>
            Esta experiencia solo aparece la primera vez que inicias sesión
          </p>
        </div>
      </div>

...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">1. RESPONSABLE DEL TRATAMIENTO</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">2. DATOS RECOPILADOS</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">3. FINALIDADES DEL TRATAMIENTO</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed mb-4">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">4. BASE LEGAL PARA EL TRATAMIENTO</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed mb-4">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">5. COMPARTICIÓN DE DATOS</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">6. TRANSFERENCIA INTERNACIONAL DE DATOS</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">7. PLAZO DE CONSERVACIÓN</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">8. DERECHOS DE LOS TITULARES DE LOS DATOS</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed mb-4">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">9. MEDIDAS DE SEGURIDAD</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed">
      ...
      <Card className="mb-6">
        <CardHeader>
          <CardTitle className="text-xl">11. CAMBIOS EN ESTA POLÍTICA</CardTitle>
        </CardHeader>
        <CardContent>
          <p className="text-foreground leading-relaxed">
      ...
      <div className="text-center text-sm text-muted-foreground">
        <p className="mb-4">
          La aceptación de esta política se formaliza mediante la marcación del checkbox correspondiente 

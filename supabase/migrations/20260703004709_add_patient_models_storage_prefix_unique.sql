...
CREATE UNIQUE INDEX patient_models_storage_prefix_key ON op3dcloud.patient_models USING btree (storage_prefix);

alter table "op3dcloud"."patient_models" add constraint "patient_models_storage_prefix_key" UNIQUE using index "patient_models_storage_prefix_key";
